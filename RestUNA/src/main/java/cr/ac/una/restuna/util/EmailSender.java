...
//        }
    ...
    private String getHead(FacturaDto factura) {
        return "<!DOCTYPE html>\n"
                ...
                + "                  <td align=\"left\" width=\"25%\" style=\"padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;\">"+factura.getIdCaja().toString()+"</td>\n"
                + "                </tr>\n"
                + "\n"
                + "                <tr>\n"
