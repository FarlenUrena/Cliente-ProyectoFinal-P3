 ...
 * @author jeez
 */
public class ItemFacturar extends HBox {

    private OrdenDto ordenDto = new OrdenDto();
    public Button btnVer = new Button();
    public Button btnFacturar = new Button();

    public ItemFacturar(OrdenDto ordenDto) {
        setOrden(ordenDto);
        init();
    }
    ...
    public void init() {
        ...
        contIdOrden.setStyle("-fx-pref-Width: 100px;"
                + "-fx-pref-height: 50px;"
                + "-fx-max-width: 100px;"
                + "-fx-max-height: 50px;"
                + "-fx-alignment: 'CENTER_LEFT';"
        ...
        HBox contBtns = new HBox();
        contBtns.setStyle("-fx-pref-Width: 150px;"
                + "-fx-pref-height: 50px;"
                + "-fx-max-width: 150px;"
                + "-fx-max-height: 50px;"
                 + "-fx-spacing: 5px;"
        ...
        btnFacturar.setStyle("-fx-font-size: 12px;"
                + "-fx-text-fill: #C9E4DB;"
        ...
        contBtns.getChildren().addAll(btnVer, btnFacturar);
        
        this.getChildren().addAll(contIdOrden, contNombCliente, contBtns);
    ...
    public Button getBtnFacturar() {
        return this.btnFacturar;
    }
